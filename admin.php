...
<table align="center" class="adminTable">
    ...
    <!-- icons -->
    <tr>
        <td align="center"><a href="list.php"><img src="./pic/wordList.png" class="adminThumbnailSize"></td>
        <td align="center"><a href="add_word.php"><img src="./pic/addAWord.png" class="adminThumbnailSize"></a></td>
        <td align="center"><a href="add_words.php"><img src="./pic/add_words.jpg" class="adminThumbnailSize"></td>
        <td align="center"><a href="add_many_words_one_image.php"><img src="./pic/add_many_words_one_image.jpg" class="adminThumbnailSize"></td>
        <td align="center"><a target="_blank" href="one_to_many.php"><img src="./pic/oneWordManyPuzzles.png" class="adminThumbnailSize"></a></td>
        <td align="center"><a target="_blank" href="many_to_one.php"><img src="./pic/manyWordsOnePuzzle.png" class="adminThumbnailSize"></a></td>
    </tr>
    ...
    <tr>
        ...
        <td align="center"><a href="add_word.php">Add Words</a></td>
    ...
    <!-- icons -->
    <tr>
        <td align="center"><a target="_blank" href="one_to_many_plus.php"><img src="./pic/oneWordManyPuzzlesPlus.png"class="adminThumbnailSize"></td>
        <td align="center"><a href="many_From_A_list.php"><img src="./pic/manyfromalist.png" class="adminThumbnailSize"></td>
        <td align="center"><a href="one_from_a_given_list.php"><img src="./pic/manyfromalist.png" class="adminThumbnailSize"></td>
        <td align="center"><a href="image_search.php"><img src="./pic/imageSearch.svg" class="adminThumbnailSize"></a></td>
        <td align="center"><a href="report.php"><img src="./pic/report.png" class="adminThumbnailSize"></td>
        <!-- <td align="center"><a href="export_db.php"><img src="./pic/export.png" class="adminThumbnailSize"></a></td>
        <td align="center"><a href="uploadPage.php"><img src="./pic/import.png" class="adminThumbnailSize"></td>  -->
    </tr>
    ...
    <tr>
        ...
        <td align="center"><a href="image_search.php">Image Search</a></td>
    ...
    <tr>
        <td align="center"><a href="export_db.php"><img src="./pic/export.png" class="adminThumbnailSize"></a></td>
        <td align="center"><a href="uploadPage.php"><img src="./pic/import.png" class="adminThumbnailSize"></td> 
        <td align="center"><a href="backup.php" onclick="backUpMessage()"><img src="./pic/backUp.png" class="adminThumbnailSize"></a></td>
        <td align="center"><a href="#"><img src="./pic/configure.png" class="adminThumbnailSize"></a></td>
        <td align="center"><a href="admin_manage_users.php"><img src="./pic/users.png" class="adminThumbnailSize"></a></td>
        <td align="center"><a href="userManual.php"><img src="./pic/user_manual.png" class="adminThumbnailSize"></a></td>
