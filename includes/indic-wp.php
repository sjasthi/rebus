...
if (file_exists($file)) {
    ...
    - Please download the latest version of sjasthi/indic-wp from GitHub and place it in the folder where the Rebus app is located.<br>
    - This folder must be titled <b>indic-wp</b>.<br>
    - For example, if wordfind is in <b>htdocs/rebus/</b> then indic-wp should be in <b>htdocs/indic-wp/</b>";
